			  	...
			  	<form action="#" method="post">
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$f_loca.'" placeholder="e.g: Lamabajar,sylhet">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="Metropoliton University">Metropoliton University</option>
							</select>
							</div>
						</div>
					<div class="itemrow">
